...
- Copy the [filebeat-config.yml](https://github.com/jvicious126/Elk-Stack/blob/ffdca81478b670744ab0ad2976a4aaaa59f2de0c/Ansible/filebeat.yml) file to /etc/ansible/.
